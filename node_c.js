...
{  
   ...
   try{
    ...
    console.log("Connected correctly to server");
     ...
     requests = await db.collection('Requests').find({allocated_node_name:"Node_c"}).toArray();
     requests_history = await db.collection('Requests_history').find({allocated_node_name:"Node_c"}).toArray();
